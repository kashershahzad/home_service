  ...
  return (
    <View style={styles.screen}>
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        ...
        {/* Special Offers */}
        <SectionHeader title="Special Offers" onSeeAll={() => router.push('/special-offers')} />
        ...
        <View style={styles.offerCarouselWrap}>
          <FlatList
            ...
            renderItem={({ item }) => (
              <View
                style={[
                  styles.offerCard,
                  { backgroundColor: item.bgColor, marginRight: OFFER_CARD_SPACING, width: OFFER_CARD_WIDTH },
                ]}
              >
          ...
          <View style={styles.offerDotsRow} pointerEvents="none">
            {OFFERS.map((_, i) => (
              <View
                key={i}
                style={[styles.offerDot, i === activeOfferIndex && styles.offerDotActive]}
              />
            ))}
          </View>
        </View>
        ...
        {/* Services */}
        <SectionHeader title="Services" onSeeAll={() => router.push('/all-services')} />
        ...
        <SectionHeader title="Most Popular Service" onSeeAll={() => router.push('/popular-services')} />
        <ScrollView
          horizontal
          showsHorizontalScrollIndicator={false}
        ...
        {loadingPopular ? (
          ...
          <Text style={styles.emptyText}>Couldn't find any popular service in this category.</Text>
        ) : (
          <FlatList
...
function TabIcon({ icon, label, active, onPress }) {
  return (
    <TouchableOpacity style={styles.tabItem} hitSlop={HIT_SLOP} onPress={onPress}>
      <Ionicons name={icon} size={24} color={active ? COLORS.primary : COLORS.subtext} />
...
const styles = StyleSheet.create({
  ...
  userName: { fontFamily: 'Roboto_800ExtraBold', fontSize: 19, fontWeight: '800', color: COLORS.text, },
  ...
  sectionTitle: { fontFamily: 'Roboto_800ExtraBold', fontSize: 16, fontWeight: '800', color: COLORS.text, },
  seeAll: { fontSize: 13, color: COLORS.primary, fontWeight: '600' },
  offerCard: { flexDirection: 'row', height: 160, borderRadius: 30, overflow: 'hidden', },
  offerTextWrap: { flex: 1, justifyContent: 'center', paddingLeft: 20, paddingVertical: 20, },
  ...
  serviceIconWrap: { width: 56, height: 56, borderRadius: 28, alignItems: 'center', justifyContent: 'center', marginBottom: 12, },
  ...
  emptyText: { textAlign: 'center', color: COLORS.subtext, fontSize: 13, marginTop: 20, marginBottom: 40, },
  popularCard: {
    flexDirection: 'row',
    alignItems: 'center',
    backgroundColor: '#FFFFFF',
  ...
  popularTitle: { fontSize: 16.5, fontWeight: '700', color: COLORS.text, marginTop: 3 },
  popularPrice: { fontSize: 14.5, color: COLORS.primary, fontWeight: '700', marginTop: 4 },
  ...
  tabLabel: { fontSize: 12, color: COLORS.subtext, marginTop: 5, fontWeight: '500', },
